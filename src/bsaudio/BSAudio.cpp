...
void BSAudio::Init(void* pHandle) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 79);
	SynchTimer.Restart();
	if (bMultiThread) {
...
void BSAudio::Shutdown() {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 99);
	if (IsAudioEnabled()) {
		if (bMultiThread) {
...
void BSAudio::SetMultiThreaded(bool abUseMultipleThreads) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 118);
	if (!IsAudioEnabled()) {
		return;
	}
...
BSSoundHandle BSAudio::GetSoundHandleByNumericID(uint aiFormID,
												 uint aiTypeFlags) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 152);
	return BSAudioManager::QInstance().GetSoundHandleByNumericID(aiFormID,
																 aiTypeFlags);
}

BSSoundHandle BSAudio::GetSoundHandleByFilename(const char* apFilename,
												uint aiTypeFlags,
												void* apSettingsContext) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 162);
	return BSAudioManager::QInstance().GetSoundHandleByFilename(
		apFilename, aiTypeFlags, apSettingsContext);
}

BSSoundHandle BSAudio::GetSoundHandleByName(const char* apSoundName,
											uint aiTypeFlags) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 172);
	return BSAudioManager::QInstance().GetSoundHandleByName(apSoundName,
															aiTypeFlags);
}

BSSoundHandle BSAudio::SpawnSoundReference(uint aiFormID, uint aiTypeFlags,
										   NiPoint3 aLoc, uint aiID) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 184);
	BSSoundHandle h = BSAudioManager::QInstance().GetSoundHandleByNumericID(
		aiFormID, aiTypeFlags);
...
void BSAudio::Update(bool abPlayGameWorldSounds) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 193);
...
void BSAudio::SetConditions(float afCurrentGamehour, uint aiWeatherConditions) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 200);
	return BSAudioManager::QInstance().SetConditions(afCurrentGamehour,
													 aiWeatherConditions);
}
...
float BSAudio::GetMasterVolume() {
	return BSAudioManager::QInstance().GetMasterVolume();
}

float BSAudio::GetFootVolume() {
	return BSAudioManager::QInstance().GetFootVolume();
}

float BSAudio::GetVoiceVolume() {
	return BSAudioManager::QInstance().GetVoiceVolume();
}

float BSAudio::GetEffectVolume() {
	return BSAudioManager::QInstance().GetEffectVolume();
}

float BSAudio::GetMusicVolume() {
	return BSAudioManager::QInstance().GetMusicVolume();
}

float BSAudio::GetRadioVolume() {
	return BSAudioManager::QInstance().GetRadioVolume();
}
...
void BSAudio::Precache(char* apSoundName, uint aiFlags) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 294);
...
void BSAudio::Precache(uint aiFormID, uint aiFlags) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 302);
	BSAudioManager::QInstance().Precache(aiFormID, aiFlags);
}

void BSAudio::Precache(char const* apFilenameToCache, uint aiFlags,
					   void* apSettingsContext) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 310);
	BSAudioManager::QInstance().Precache(apFilenameToCache, aiFlags,
										 apSettingsContext);
}
...
void BSAudio::SetAudioCacheSizeInK(uint aiNewSize) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 318);
...
uint BSAudio::GetAudioCacheSizeInK() {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 325);
...
void BSAudio::SetCacheEnabled(bool abEnableCache) {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 332);
...
bool BSAudio::GetCacheEnabled() {
	AutoMemContext amc(
		MEM_CONTEXT_AUDIO, true,
		"D:\\_Fallout3\\Platforms\\Common\\Code\\BSAudio\\BSAudio.cpp", 339);
	return BSAudioManager::QInstance().GetCacheEnabled();
}

void BSAudio::MuteType(uint aiType, uint aiFadeTimeMS, uint aiMillibels) {
	BSAudioManager::QInstance().MuteAllOfType(aiType, aiFadeTimeMS,
											  aiMillibels);
}
...
void BSAudio::StopMovingSounds(NiAVObject* apObj, float afFadeSeconds,
							   uint aiFlags) {
