...
class BSAudioManager {
  public:
	...
	BSSoundHandle SpawnSoundReference(uint aiFormID, uint aiTypeFlags,
	...
	void SetAttenuationCurve(uint, uint16_t, uint16_t, uint16_t, uint16_t,
							 uint16_t);
	...
	void ComposeMessage(SOUND_MSG, uint, int, void*, NiPointer<NiAVObject>,
						NiPoint3);
