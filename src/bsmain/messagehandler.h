...
class MessageHandler : public BSCoreMessage {
  public:
	...
	static void Init(bool, bool, bool, bool,
					 s32 (*const)(char const*, char const*, u32));
	static void InitSDM();
	// static void SetLoadingStream(BSStream *);
	static void SetMessageBoxCallback(s32 (*const)(char const*, char const*,
												   u32));
  ...
  protected:
	...
	virtual BSCoreMessage::MsgReturn Message(BSCoreMessage::MsgStyle,
											 char const*, char const*, u32,
											 u32) override;
