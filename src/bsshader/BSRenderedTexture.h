...
class BSRenderedTexture : public NiObject {
  public:
	...
	BSRenderedTexture(NiRenderedTexture*, NiRenderedTexture*, bool,
	...
	static BSRenderedTexture* Create(const NiFixedString&, Ni2DBuffer*, bool,
									 NiDepthStencilBuffer*);
	static BSRenderedTexture* Create(const NiFixedString&, uint, uint,
									 Ni2DBuffer::MultiSamplePreference, bool,
									 NiDepthStencilBuffer*, NiRenderedTexture*,
									 uint);
	static BSRenderedTexture* Create(const NiFixedString&, uint, uint,
	...
	static NiDepthStencilBuffer* GetDepthStencilBuffer(NiRenderedTexture*,
													   NiDepthStencilBuffer*);
