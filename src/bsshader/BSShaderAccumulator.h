...
class BSShaderAccumulator : public NiAlphaAccumulator {
  public:
	...
	static bool (*pRegisterObjectFunc[16])(BSShaderAccumulator*, NiGeometry*,
										   const NiPropertyState*,
										   BSShaderProperty*, BSShader*);
	static bool (*RegisterObjectCurrent)(BSShaderAccumulator*, NiGeometry*,
										 const NiPropertyState*,
										 BSShaderProperty*, BSShader*);
	...
	BSShaderAccumulator(BSShaderManager::BATCHRENDERER_CREATION_MODE, uint,
						uint);
	...
	void GetDebugStats(uint&, uint&, uint&, uint&, uint&, uint&, uint&, uint&,
					   uint&, uint&, uint&);
	...
	void RenderBatches(BSShaderManager::eBSSMPassEnum,
					   BSShaderManager::eBSSMPassEnum, bool, int);
	void ClearActivePasses();
	void RenderGeometryGroup(uint, bool);
	void SortAlphaPasses();
	bool QPassesWithinRange(BSShaderManager::eBSSMPassEnum,
							BSShaderManager::eBSSMPassEnum);
	bool QWaterRefractionPassWithinRange(BSShaderManager::eBSSMPassEnum,
										 BSShaderManager::eBSSMPassEnum);
	...
	static bool RegisterObject_Standard(BSShaderAccumulator*, NiGeometry*,
										const NiPropertyState*,
										BSShaderProperty*, BSShader*);
	static bool RegisterObject_Interface(BSShaderAccumulator*, NiGeometry*,
										 const NiPropertyState*,
										 BSShaderProperty*, BSShader*);
	static bool RegisterObject_Frozen(BSShaderAccumulator*, NiGeometry*,
									  const NiPropertyState*, BSShaderProperty*,
									  BSShader*);
	static bool RegisterObject_ScreenSplatter(BSShaderAccumulator*, NiGeometry*,
											  const NiPropertyState*,
											  BSShaderProperty*, BSShader*);
	static bool RegisterObject_LocalMap(BSShaderAccumulator*, NiGeometry*,
										const NiPropertyState*,
										BSShaderProperty*, BSShader*);
	static bool RegisterObject_WaterDepth(BSShaderAccumulator*, NiGeometry*,
										  const NiPropertyState*,
										  BSShaderProperty*, BSShader*);
	static bool RegisterObject_ConstAlpha(BSShaderAccumulator*, NiGeometry*,
										  const NiPropertyState*,
										  BSShaderProperty*, BSShader*);
