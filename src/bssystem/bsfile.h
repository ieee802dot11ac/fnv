...
class BSHash {
  public:
	...
	BSHash();
	BSHash(unsigned char, unsigned char, unsigned char, unsigned char,
		   unsigned int);
	BSHash(const char*, HASHPROCESS);
	void GetAll(unsigned char&, unsigned char&, unsigned char&, unsigned char&,
				unsigned int&);
...
class BSFile : public NiFile {
  public:
	...
	static unsigned int RdNoSwap(NiBinaryStream*, void*, unsigned int,
								 unsigned int*, unsigned int);
	static unsigned int WrNoSwap(NiBinaryStream*, const void*, unsigned int,
								 unsigned int*, unsigned int);
	static unsigned int RdSwap(NiBinaryStream*, void*, unsigned int,
							   unsigned int*, unsigned int);
	static unsigned int WrSwap(NiBinaryStream*, const void*, unsigned int,
							   unsigned int*, unsigned int);
