...
public:
    ...
    void SetEditorLocation(TESWorldSpace *, TESObjectCELL *, const NiPoint3 &, float);
    ...
    void MoveActorAndFollowers(
        const NiPoint3 &, float, TESObjectCELL *, TESWorldSpace *, bool, bool
    );
    float GetRadius();
    float GetWidth();
    float GetLength();
    ...
    virtual void
    InitiateSandmanPackage(Actor *, TESObjectREFR *, FurnitureMark *, unsigned char);
    ...
    int GetDetectionLevelAgainstActor(bool, Actor *, bool &, bool, bool, bool, bool *);
    ...
    bool
    PutItemInReference(TESBoundObject *, ExtraDataList *, TESObjectREFR *, int, uint);
    ...
    DropObject(TESObject *, ExtraDataList *, int, const NiPoint3 *, const NiPoint3 *);
    ...
    bool
    HasObjects(TESBoundObject *, PACKAGE_OBJECT_TYPE, int, uint, PACKAGE_OBJECT_TYPE &);
    void CastAlchemy(BSSimpleList<MagicItem *> *);
    void CastAlchemy(MagicItem *, bool);
    virtual bool
    CheckCastWhenStrikesEnchantment(ItemChange *, Actor *, Projectile *, bool &);
    ...
    virtual BSSoundHandle VoiceSoundFunction(TESTopic *, Actor *, bool, bool, bool, bool);
    ...
    virtual void InitiateFlee(
        TESObjectREFR *, bool, bool, bool, TESObjectCELL *, TESObjectREFR *, float, float
    );
    ...
    virtual void
    StartCombat(Actor *, CombatGroup *, bool, bool, bool, int, bool, TESPackage *);
    ...
    ANIM_GROUP_ENUM GetIronSightsAttack(Animation *, ANIM_GROUP_ENUM, TESObjectWEAP *);
    ...
    NiAVObject *
    ExplodeLimb(BGSBodyPart::LIMB_ENUM, NiAVObject *, const NiTransform &, bool);
    void HideDismemberedLimb(BGSBodyPart::LIMB_ENUM, NiNode *, NiAVObject *, bool);
    void UnhideDismemberedLimb(BGSBodyPart::LIMB_ENUM, NiNode *);
    void DismemberLimb(ActorValue::Index, BGSBodyPart::LIMB_ENUM, bool, bool, bool, bool);
    ...
    uint IntegrateFactionLists(
        TESFaction **, uint, BSSimpleList<FACTION_RANK *> *, BSSimpleList<FACTION_RANK *> *
    );
    ...
    void QueueEquipObject(TESBoundObject *, int, ExtraDataList *, bool, bool, bool);
    void QueueUnEquipObject(TESBoundObject *, int, ExtraDataList *, bool, bool, bool);
...
protected:
    ...
    bool ObjectHit(bool);
    void FakeWeaponHitSound(NiPoint3, TESObjectREFR *, bhkRigidBody *, MATERIAL_TYPE);
...
public:
    ...
    bool SetPathfindingGoal(
        const NiPoint3 &, TESObjectCELL *, TESWorldSpace *, float, PathingAvoidNodeArray *
    );
    bool SetPathfindingGoal(PathingRequest *);
    bool SetPathfindingGoalAndAngle(TESObjectREFR *, float, PathingAvoidNodeArray *);
    bool SetPathfindingGoalAndAngle(
        const NiPoint3 &,
        TESObjectCELL *,
        TESWorldSpace *,
        float,
    ...
    void ResumeMoving();
    void BuildRequest(
        PathingRequest *, const NiPoint3 &, TESForm *, float, PathingAvoidNodeArray *
    );
    void BuildRequest(
        PathingRequest *,
        const NiPoint3 &,
...
public:
    ...
    static void ConditionModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void MobilityConditionModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void AggressionModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void AssistanceModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void InventoryWeightModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void DamageResistanceModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void DamageThresholdModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void MedicineSkillModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void SurvivalSkillModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void ParalysisModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void HealingRateModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void EnduranceModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void HealthFatigueModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void RadiationResistanceModifiedCallback(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    ...
    static void CheckRadiationLevelChange(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void CheckDehydrationLevelChange(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void CheckHungerLevelChange(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
    static void CheckSleepDeprevationLevelChange(
        ActorValueOwner *, ActorValue::Index, float, float, ActorValueOwner *
    );
