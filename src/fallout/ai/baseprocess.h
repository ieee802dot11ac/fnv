...
class BaseProcess { /* Size=0x30 */
  public:
	...
	virtual bool SetupSpecialIdle(MobileObject*, TESIdleForm*,
								  AnimIdle::PLAY_TYPE_ENUM, bool, bool, bool);
	...
	virtual bool CheckAndStartCombatControllerForPackage(Actor*, TESPackage*,
														 bool);
	...
	virtual DetectionState* InsertIntoDetectionList(Actor*, DETECTION_LEVEL,
	...
	virtual void SetActorsDetectionEvent(Actor*, NiPoint3, int, int,
										 TESObjectREFR*);
	...
	virtual void AddQueuedItem(Actor*, bool, TESBoundObject*, int,
							   ExtraDataList*, bool, bool, bool, bool, bool,
							   bool);
	...
	virtual void AddAvoidPathingArea(Actor*, NiPoint3, float, float,
									 TESObjectREFR*, TESObjectSTAT*);
	...
	virtual bool EnterCombat(Actor*, Actor*, bool, bool, CombatGroup*, bool,
							 bool, bool, char, bool, bool, bool, TESPackage*);
	...
	virtual void SetSitSleepState(Actor*, SIT_SLEEP_STATE, TESObjectREFR*,
								  unsigned char);
	...
	virtual bool ShouldCheckFlare(BSSimpleList<ActiveEffect*>*,
								  MagicSystem::FlareType);
	...
	virtual void NotifyGuardAboutActivation(Actor*, TESObjectREFR*,
											TESObjectREFR*);
	...
	virtual void SetHeadTrackTarget(BaseProcess::HEAD_TRACK_TYPE,
									TESObjectREFR*);
	...
	virtual TESObjectREFR*
		GetCurrentHeadTrackTarget(BaseProcess::HEAD_TRACK_TYPE);
	...
	virtual void DeferHideDismemberedLimb(BGSBodyPart::LIMB_ENUM, NiNode*,
										  NiAVObject*, bool);
