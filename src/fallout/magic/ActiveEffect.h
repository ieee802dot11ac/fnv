...
class ActiveEffect {
  ...
  public:
	...
	static void SaveActiveEffectList(BGSSaveFormBuffer*,
									 BSSimpleList<ActiveEffect*>*);
	static void SaveActiveEffectList(BSSimpleList<ActiveEffect*>*, Actor*);
	static void LoadActiveEffectList(BGSLoadFormBuffer*,
									 BSSimpleList<ActiveEffect*>*);
	static void LoadActiveEffectList(BSSimpleList<ActiveEffect*>*, Actor*);
	static void InitLoadGameActiveEffectList(BSSimpleList<ActiveEffect*>*,
											 Actor*);
	static void FinishInitLoadGameActiveEffectList(BSSimpleList<ActiveEffect*>*,
												   Actor*);
	static void RevertActiveEffectList(BGSLoadFormBuffer*,
									   BSSimpleList<ActiveEffect*>*);
	static void RevertActiveEffectList(BSSimpleList<ActiveEffect*>*, Actor*);
	static void InitLoadActiveEffectList(BGSLoadFormBuffer*,
										 BSSimpleList<ActiveEffect*>*);
	static void FinishLoadActiveEffectList(BGSLoadFormBuffer*,
										   BSSimpleList<ActiveEffect*>*);
