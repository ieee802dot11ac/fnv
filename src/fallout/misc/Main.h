...
class Main {
  public:
	...
	// void DrawWorld_End(BSRenderedTexture *, ImageSpaceManager *,
	// NiXenonRenderer *, Sun
	...
	// void DrawWorld_RestartRenderTexture(BSRenderedTexture *, bool, unsigned
	// __int32);
	...
	// BSRenderedTexture *DrawWorld_InitRenderTexture(NiXenonRenderer *,
	// BSRenderedTexture
	// *, bool, bool);
