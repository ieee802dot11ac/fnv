...
class BSTextureSet : public NiObject {
  public:
	...
	virtual const char*
		GetTextureFilename(BSShaderProperty::TextureTypeEnum) const;
	virtual void GetTexture(BSShaderProperty::TextureTypeEnum,
							NiPointer<NiTexture>&) const;
	virtual void SetTextureFilename(BSShaderProperty::TextureTypeEnum,
									const char*);
