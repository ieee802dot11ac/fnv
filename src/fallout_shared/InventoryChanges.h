...
public:
    ...
    void
    CreateExtraDataList(TESBoundObject *, int, Actor *, ExtraDataList *, ItemChange *);
    bool IsEmpty();
    ...
    TESObjectREFR *DropItemIntoWorld(
        TESObjectREFR *,
        TESBoundObject *,
        int,
        TESObjectREFR *,
    ...
    void PutItemIntoContainer(TESBoundObject *, int, TESObjectREFR *, ExtraDataList *);
    ...
    float RemoveAllTypedItems(
        TESObjectREFR *, TESObjectREFR *, bool, bool, bool, bool, int, BGSListForm *
    );
    float RemoveAllItems(
        TESObjectREFR *, TESObjectREFR *, bool, bool, bool, bool, int, BGSListForm *
    );
    ...
    unsigned int IterateInventory(bool (*)(ItemChange *, void *), void *, unsigned int);
