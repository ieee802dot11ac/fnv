...
int TESCaravanCard::SortCardsFunc(const void* t1, const void* t2) {
	const TESCaravanCard* c1 =
		*reinterpret_cast<const TESCaravanCard* const*>(t1);
	const TESCaravanCard* c2 =
		*reinterpret_cast<const TESCaravanCard* const*>(t2);
...
void TESCaravanDeck::InitializeData() {
	pDeck = new ("D:\\_Fallout3\\Platforms\\Common\\Code\\Fallout "
				 "Shared\\TESCaravan.cpp",
				 490, __FUNCTION__) BSSimpleList<TESCaravanCard*>;
	data.iDeckSize = 0;
}
