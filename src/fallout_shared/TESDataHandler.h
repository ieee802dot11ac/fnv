...
public:
    ...
    void EnumReferencesCloseToRef(
        TESObjectREFR *, float, const NiPoint3 &, float, bool (*)(TESObjectREFR *, int), int
    );
    bool FindTeleportPathBetweenSmallSpaces(
        TESForm *, TESForm *, BSSimpleList<TESObjectREFR *> *
    );
    bool FindTeleportPathBetweenWorlds(
        TESWorldSpace *, TESWorldSpace *, BSSimpleList<TESObjectREFR *> *
    );
    bool FindTeleportPathFromSmallSpaceToWorld(
        TESForm *, TESWorldSpace *, BSSimpleList<TESObjectREFR *> *, bool
    );
    TESObjectREFR *FindFirstReference(TESObject *);
    TESObjectREFR *FindFirstReference(char *);
    bool
    FindConnectedWorld(TESWorldSpace *, TESWorldSpace *, BSSimpleList<TESObjectREFR *> *);
    bool FindConnectedSmallSpace(
        TESForm *,
        TESForm *,
        BSSimpleList<TESObjectREFR *> *,
        BSSimpleList<TESObjectREFR *> *
    );
    TESWorldSpace *FindEntryPoint(TESForm *, NiPoint3 &, BSSimpleList<TESObjectREFR *> *);
    TESObjectREFR *
    FindClosestReference(TESBoundObject *, const NiPoint3 &, TESObjectCELL *);
    ...
    TESObjectREFR *CreateReferenceInLoadedArea(
        TESBoundObject *, const NiPoint3 &, const NiPoint3 &, bool, BGSPrimitive *, void *
    );
    TESObjectREFR *CreateReferenceAtLocation(
        TESBoundObject *,
        const NiPoint3 &,
        const NiPoint3 &,
        TESObjectCELL *,
    ...
    TESObjectREFR *CreateProjectileAtLocation(
        TESBoundObject *,
        const NiPoint3 &,
        const NiPoint3 &,
        TESObjectCELL *,
    ...
    TESObjectREFR *CreateExplosionAtLocation(
        TESBoundObject *,
        const NiPoint3 &,
        const NiPoint3 &,
        TESObjectCELL *,
...
protected:
    ...
    BSSimpleList<MediaLocationController *> listMediaLocationControllers; // 0x1d0
