...
public:
    ...
    void ResetQuest();
    bool ValidateTargetList(
        BSSimpleList<TESQuestTarget *> *, BSSimpleList<BGSQuestObjective *> *
    );
    void UpdateCurrentTargetList(
        BSSimpleList<TESQuestTarget *> *, BSSimpleList<BGSQuestObjective *> *
    );
    ...
    static void
    GetQuestLog(BSSimpleList<TESQuestStageItem *> *, TESQuest *, bool, bool, bool);
