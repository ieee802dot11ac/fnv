...
void Script::InitActionList(TESObjectREFR* ownerObject,
							ExtraDataList* apExtra) {}

void Script::RunScriptEffectStart(TESObjectREFR* apTargetRef,
								  ScriptLocals* apEffectLocals) {
	ScriptRunManager::Instance()->Run(this, apTargetRef, apEffectLocals,
									  nullptr, false, true, false, 0.0f);
}

void Script::RunScriptEffectFinish(TESObjectREFR* apTargetRef,
								   ScriptLocals* apEffectLocals) {
	ScriptRunManager::Instance()->Run(this, apTargetRef, apEffectLocals,
									  nullptr, false, false, true, 0.0f);
}

void Script::RunScriptEffectUpdate(TESObjectREFR* apTargetRef,
								   ScriptLocals* apEffectLocals,
								   float afSecondsElapsed) {
	ScriptRunManager::Instance()->Run(this, apTargetRef, apEffectLocals,
...
ACTION_OBJECT* ScriptLocals::GetActionObject(TESForm* apActionForm,
											 bool abReturnDefault) {
