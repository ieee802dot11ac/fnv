...
class ScriptCompiler { /* Size=0x1 */
  ...
  public:
	...
	static bool StandardCompile(const unsigned short, const SCRIPT_PARAMETER*,
								SCRIPT_LINE*, ScriptCompileData*);
	static bool MessageBoxCompile(const unsigned short, const SCRIPT_PARAMETER*,
								  SCRIPT_LINE*, ScriptCompileData*, bool, bool);
	static bool MessageBoxCompile(const unsigned short, const SCRIPT_PARAMETER*,
								  SCRIPT_LINE*, ScriptCompileData*);
	static bool MessageCompile(const unsigned short, const SCRIPT_PARAMETER*,
							   SCRIPT_LINE*, ScriptCompileData*);
	static bool OldMessageCompile(const unsigned short, const SCRIPT_PARAMETER*,
								  SCRIPT_LINE*, ScriptCompileData*);
  ...
  protected:
	...
	unsigned int ReplaceVariablesAndFunctions(ScriptCompileData*,
											  const SCRIPT_LINE*, char*, char*);
	...
	static int GetNextWord(ScriptCompileData*, SCRIPT_WORD*, const char*,
