...
class TESTopic : public TESForm, public TESFullName {
  public:
	...
	DialogueItem* CreateDialogueItem(TESObjectREFR*, TESObjectREFR*, TESTopic*,
									 BSSimpleList<DialogueItem*>*, bool);
	TESTopicInfo* GetMatchingInfo(bool&, TESObjectREFR*, TESObjectREFR*, bool,
								  TESTopic*,
								  BSSimpleList<DialogueItem*>*) const;
	...
	static unsigned int CreateConversation(TESObjectREFR*, TESObjectREFR*,
										   BSSimpleList<DialogueItem*>*,
										   TESTopic*);
	static TESTopicInfo* GetMatchingFollowUpInfo(TESTopicInfo*, bool&,
  ...
  protected:
	static TESTopicInfo* GetMatchingInfo(const TESTopic*, bool&, TESObjectREFR*,
										 TESObjectREFR*, bool, TESTopic*,
										 BSSimpleList<DialogueItem*>*);
