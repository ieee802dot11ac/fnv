...
class TESWorldSpace : public TESForm, public TESFullName, public TESTexture {
  public:
	...
	virtual TESForm* CreateDuplicateForm(bool,
										 NiTPointerMap<TESForm*, TESForm*>*);
	...
	virtual void GetGrassForLocation(NiPoint2, NiPoint2, TESGrassAreaParam*,
									 uint);
  ...
  protected:
	...
	NiTPointerMap<uint, BSSimpleList<TESObjectREFR*>*>
		FixedPersistentRefMap;							  // 0x60
	BSSimpleList<TESObjectREFR*> MobilePersistentRefList; // 0x70
	NiTPointerMap<uint, BSSimpleList<TESObjectREFR*>*>*
		pOverlappedMultiboundMap;				  // 0x78
