...
class ActorValue {
  public:
	...
	static void CheckCallModifiedCallback(ActorValueOwner*, Index, float, float,
										  ActorValueOwner*);
  ...
  private:
	static void RegisterActorValue(Index, char*, Section, unsigned int,
								   float (*)(ActorValueOwner*, Index),
								   Index (*)(ActorValueOwner*, Index),
								   void (*)(ActorValueOwner*, Index, float,
...
class ActorValueInfo : public TESForm /*, public TESFullName, public
										 TESDescription, public TESIcon*/
{
  public:
	...
	ActorValue::Index (*pMappingFunction)(ActorValueOwner*,
										  ActorValue::Index); // 0x60
	void (*pModifiedCallback)(ActorValueOwner*, ActorValue::Index, float, float,
							  ActorValueOwner*); // 0x64
