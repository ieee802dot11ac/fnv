...
class BipedAnim {
  public:
	...
	void
	RecursivelyRemoveAllDecalPlacementVectorDataFromWeaponBone(NiAVObject*);
	...
	// void QueueBipedParts(IO_TASK_PRIORITY, NiPointer<QueuedHelmet> &,
	// QueuedFile *); void QueueSkinTextures(unsigned int, IO_TASK_PRIORITY,
	// QueuedFile *); void QueueSkinTexture(TESNPC *, BIPED_OBJECT,
	// IO_TASK_PRIORITY, QueuedFile *);
	...
	//     IO_TASK_PRIORITY, QueuedFile *, NiPointer<QueuedHelmet> &,
	//     BIPED_OBJECT
	// );
	...
	//     NiNode *, NiNode *, NiNode *, BipedAnim *, BIPED_OBJECT,
	//     BSFaceGenModel *
	// );
	// static NiAVObject *
	// LoadAndAttachAddOn(TESForm *, TESModel *, BIPED_OBJECT, TESObjectREFR *,
	// NiAVObject
	// *);
	...
	// static BIPED_OBJECT GetSkinBipedObject(NiAVObject *,
	// BSShaderPPLightingProperty *);
	static unsigned int GetSkinModelFlags(NiAVObject*);

  protected:
	// NiAVObject *ApplySkinnedObjects(NiNode *, BIPED_OBJECT, bool, bool,
	// BSFaceGenModel
	// *); NiAVObject * AttachSkinnedObject(NiNode *, NiNode *, BIPED_OBJECT,
	// bool, bool, BSFaceGenModel *);
