...
static SETTING(GameSettingCollection, sMagicCastInsufficientMagicka,
			   "You don't have enough Magicka");
static SETTING(GameSettingCollection, sMagicCastInsufficientSkill,
			   "Your skill level is too low");
static SETTING(GameSettingCollection, sMagicCastSilenced,
			   "You are currently Silenced");
static SETTING(GameSettingCollection, sMagicCastPowerUsed,
			   "You can only cast Powers once per day");
static SETTING(GameSettingCollection, sMagicCastMultipleBoundEffects,
			   "You already have that kind of Bound Item");
static SETTING(GameSettingCollection, sMagicCastRangedUnderwater,
...
EffectSetting* MagicItem::GetAVEffect(MagicSystem::Range aeRange) {
	return nullptr;
}
...
BSStringT<char>
MagicItem::GetCannotCastString(MagicItem::CannotCastReason aeReason) {
	const char* ret;
	switch (aeReason) {
	case NOCAST_MAGICKA: {
