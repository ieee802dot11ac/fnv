...
class EffectArchetypes {
  public:
	struct ArchetypeDef {
		...
		ActiveEffect* (*pInstantiateFunction)(MagicCaster*, MagicItem*,
											  EffectItem*); // 0x4
	...
	static bool RegisterActiveEffect(ArchetypeID,
									 ActiveEffect* (*)(MagicCaster*, MagicItem*,
													   EffectItem*));
	static ActiveEffect* Activate(MagicCaster*, MagicItem*, EffectItem*,
								  TESBoundObject*);
