...
class TESBoundObject : public TESObject {
  public:
	...
	static void CalcBoundingBox(NiAVObject*, NiPoint3*, NiPoint3*,
								const NiPoint3&, const NiMatrix3&,
								const float&);
	static void CalcBoundingBoxRecursive(NiAVObject*, NiPoint3*, NiPoint3*,
										 bool&, bool&, const NiPoint3&,
										 const NiMatrix3&, const float&);
