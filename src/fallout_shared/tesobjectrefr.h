...
class TESObjectREFR : public TESForm, public TESChildCell {
	...
	//   virtual TESForm* CreateDuplicateForm(bool, NiTPointerMap<TESForm
	//   *,TESForm *>*); virtual void PostDuplicateProcess(NiTPointerMap<TESForm
	//   *,TESForm *>*);
	virtual void Save();
	...
	//   bool GetClosestFreeSitMarker(const NiPoint3&, FurnitureMark&, unsigned
	//   int&, bool); bool GetClosestFreeSleepMarker(const NiPoint3&,
	//   FurnitureMark&, unsigned int&, bool); bool GetClosestFreeMarker(const
	//   NiPoint3&, bool, bool, FurnitureMark&, unsigned int&, bool);
	...
	//   virtual TESObjectREFR* RemoveItem(TESBoundObject*, ExtraDataList*, int,
	//   bool, bool, TESObjectREFR*, const NiPoint3*, const NiPoint3*, bool,
	//   bool); virtual void RemoveItemType(ENUM_FORM_ID, bool, int); virtual
	//   bool AddWornItem(TESBoundObject*, int, ExtraDataList*, bool); virtual
	//   bool RemoveWornItem(TESBoundObject*, int, ExtraDataList*); virtual void
	...
	//   void GetOEIFastInventoryIterator(const bool,
	//   OEI_Fast_InventoryIterator**, InventoryChanges**);
	...
	//   void SetPackageStartLocation(TESWorldSpace*, TESObjectCELL*, const
	//   NiPoint3&, float); virtual void AddObjecttoContainer(TESBoundObject*,
	//   ExtraDataList*, int);
	...
	//   BGSBodyPart::LIMB_ENUM, bool); void
	//   SetLimbRemoved(BGSBodyPart::LIMB_ENUM, bool); bool
	//   GetDismembered(BGSBodyPart::LIMB_ENUM); CAUSE_OF_DEATH
	//   GetCauseofDeath();
	...
	//   SaveControllerManager(NiControllerManager*, BGSSaveGameBuffer*, float);
	//   static void SaveControllerManager(NiControllerManager*, float); static
	//   void LoadControllerManager(NiControllerManager*, BGSLoadGameBuffer*,
	//   float); static void LoadControllerManager(NiControllerManager*,
	//   NiAVObject*, float);
	static void SayToCallBack(void*, bool);
	static void SoundFileCallBack(void*, bool);
	//   static void
	//   GatherHavokSaveDataForCollisionObject(bhkNiCollisionObject*,
	//   bhkWorldNS::ObjectRecData&); static void
	...
	//   static bool QVerticesInsideMultiboundRecurse(NiAVObject*,
	//   BSMultiBound*, bool&, bool);
	static void SetDroppedItemData(TESObjectREFR*, TESObjectREFR*);
	//   static void FilteredAddObject(bhkNiCollisionObject*,
	//   bhkWorldNS::ObjectRecData&);
	...
	//   static void MoveRefToNewSpace(TESObjectREFR*, TESObjectCELL*,
	//   TESWorldSpace*); static bool GetDistant3DDataFromFile(TESFile*,
	//   DISTANT_3D_REF_DATA*); static void
	//   TransChangeCallback(bhkNiCollisionObject*, unsigned int); static void
	//   DebugDisplayCallback(NiGeometry*, const NiColor&);
