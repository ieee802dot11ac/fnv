...
class NiColorKey : public NiAnimationKey {
  public:
	...
	static NiColorA GenInterp(float, NiColorKey*, NiAnimationKey::KeyType,
	...
	static void (*GetSaveFunction(NiAnimationKey::KeyType))(NiStream&,
															NiAnimationKey*,
															unsigned int);
	...
	static NiAnimationKey* (*GetArrayFunction(NiAnimationKey::KeyType))(
		unsigned int);
	static void (*GetDeleteFunction(NiAnimationKey::KeyType))(NiAnimationKey*);
	static bool (*GetInsertFunction(NiAnimationKey::KeyType))(float,
															  NiAnimationKey*&,
															  unsigned int&);
  ...
  protected:
	...
	static NiColorA GenInterpDefault(float, NiColorKey*,
									 NiAnimationKey::KeyType, unsigned int,
									 unsigned char);
};
