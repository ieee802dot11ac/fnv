...
class NiAVObject : public NiObjectNET {
  ...
  public:
	...
	void SetRotateAboutCenter(const NiMatrix3&, const NiPoint3&,
							  const NiPoint3&);
	void SetScale(float);
  ...
  protected:
	...
	void CloneProperties(NiAVObject*, NiTPointerList<NiPointer<NiProperty> >*,
						 NiCloningProcess&);
	void ProcessPropertyClones(NiTPointerList<NiPointer<NiProperty> >*,
							   NiCloningProcess&);
  ...
  public:
	BSNiBound* m_kWorldBound; // 0x20
  protected:
	NiTPointerList<NiPointer<NiProperty> > m_kPropertyList; // 0x24
	uint m_uFlags;											// 0x30
	NiTransform m_kLocal;									// 0x40
	NiTransform m_kWorld;									// 0x80
};
