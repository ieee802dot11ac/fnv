...
public:
    ...
    bool
    WindowPointToRay(int, int, NiPoint3 &, NiPoint3 &, const NiRenderTargetGroup *) const;
    void ViewPointToRay(float, float, NiPoint3 &, NiPoint3 &) const;
    void ScreenSpaceBoundBound(const NiBound &, NiPoint3 &, NiPoint3 &, float) const;
    ...
    bool WorldPtToScreenPt3(const NiPoint3 &, float &, float &, float &, float) const;
