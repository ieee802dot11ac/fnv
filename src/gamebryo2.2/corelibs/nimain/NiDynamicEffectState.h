...
class NiDynamicEffectState : public NiRefObject {
  ...
  protected:
	...
	static bool ListsEqual(const NiDynamicEffectState::ListItem*,
						   const NiDynamicEffectState::ListItem*);
	static void ListDelete(NiDynamicEffectState::ListItem*&);
	static void ListCopy(const NiDynamicEffectState::ListItem*,
						 NiDynamicEffectState::ListItem*&);
	static void ListInsertSorted(NiDynamicEffectState::ListItem*&,
								 NiDynamicEffect*);
