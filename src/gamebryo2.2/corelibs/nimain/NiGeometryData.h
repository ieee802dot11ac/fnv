...
class NiGeometryData : public NiObject {
  public:
	...
	class RendererData {
	  public:
		...
		virtual bool
			ContainsVertexData(NiShaderDeclaration::ShaderParameter) const;
		RendererData();
	};
	...
	void Replace(u16, NiPoint3*, NiPoint3*, NiColorA*, NiPoint2*, u16,
				 DataFlags);
	...
	void SetData(u16, NiPoint3*, NiPoint3*, NiColorA*, NiPoint2*, u16,
				 DataFlags);
	void ReplaceData(u16, NiPoint3*, NiPoint3*, NiColorA*, NiPoint2*, u16,
					 DataFlags);
  ...
  protected:
	NiGeometryData();
	NiGeometryData(u16, NiPoint3*, NiPoint3*, NiColorA*, NiPoint2*, u16,
				   DataFlags);
