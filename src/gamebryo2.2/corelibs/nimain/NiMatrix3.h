...
class NiMatrix3 { /* Size=0x30 */
  public:
	...
	static void TransformVertices(const NiMatrix3&, const NiPoint3&,
								  unsigned int, const NiPoint3*, NiPoint3*);
	static void TransformNormals(const NiMatrix3&, unsigned int,
								 const NiPoint3*, NiPoint3*);
	static void TransformVerticesAndNormals(const NiMatrix3&, const NiPoint3&,
											unsigned int, const NiPoint3*,
											NiPoint3*, const NiPoint3*,
											NiPoint3*);
