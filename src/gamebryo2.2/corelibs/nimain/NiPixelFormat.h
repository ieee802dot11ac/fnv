...
class NiPixelFormat {
  public:
	...
	NiPixelFormat(Format, u8, Tiling, bool, uint, Component, Representation, u8,
				  bool, Component, Representation, u8, bool, Component,
				  Representation, u8, bool, Component, Representation, u8,
				  bool);
	NiPixelFormat(Format, Component, Representation, u8, Component,
				  Representation, u8, Component, Representation, u8, Component,
				  Representation, u8);
	NiPixelFormat(Format, Component, Representation, u8, Component,
				  Representation, u8, Component, Representation, u8);
	NiPixelFormat(Format, Component, Representation, u8, Component,
				  Representation, u8);
  ...
  protected:
	void InitPixelFormat(Format, u8, Tiling, bool, uint, Component,
						 Representation, u8, bool, Component, Representation,
						 u8, bool, Component, Representation, u8, bool,
						 Component, Representation, u8, bool);
