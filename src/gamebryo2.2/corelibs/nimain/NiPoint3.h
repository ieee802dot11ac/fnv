...
class NiPoint3 {
  public:
	...
	static void PointsPlusEqualFloatTimesPoints(NiPoint3* __restrict, float,
												NiPoint3 const* __restrict,
												uint);
	static void WeightedPointsPlusWeightedPoints(NiPoint3* __restrict, float,
												 NiPoint3 const* __restrict,
												 uint);
