...
class NiRenderedTexture : public NiTexture {
  public:
	...
	static NiRenderedTexture* Create(const NiFixedString&, Ni2DBuffer*,
									 NiRenderer*,
									 Ni2DBuffer::MultiSamplePreference);
	static NiRenderedTexture* Create(const NiFixedString&, uint, uint,
									 NiRenderer*, NiTexture::FormatPrefs&,
									 Ni2DBuffer::MultiSamplePreference,
									 NiRenderedTexture*, uint);
	static NiRenderedTexture* Create(const NiFixedString&, uint, uint,
									 NiRenderer*,
									 Ni2DBuffer::MultiSamplePreference,
									 NiRenderedTexture*, uint);
