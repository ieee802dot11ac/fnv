  ...
  public:
	class NiShaderInstanceDescriptor {
	  public:
		...
		static bool IsExactKindOf(const NiRTTI*,
								  const NiShaderInstanceDescriptor*);
	...
	virtual uint PreProcessPipeline(NiGeometry*, const NiSkinInstance*,
									NiGeometryData::RendererData*,
									const NiPropertyState*,
									const NiDynamicEffectState*,
									const NiTransform&, const NiBound&);
	virtual uint UpdatePipeline(NiGeometry*, const NiSkinInstance*,
								NiGeometryData::RendererData*,
								const NiPropertyState*,
								const NiDynamicEffectState*, const NiTransform&,
								const NiBound&);
	virtual uint SetupRenderingPass(NiGeometry*, const NiSkinInstance*,
									NiGeometryData::RendererData*,
									const NiPropertyState*,
									const NiDynamicEffectState*,
									const NiTransform&, const NiBound&);
	virtual uint SetupTransformations(NiGeometry*, const NiSkinInstance*,
									  const NiSkinPartition::Partition*,
									  NiGeometryData::RendererData*,
									  const NiPropertyState*,
									  const NiDynamicEffectState*,
									  const NiTransform&, const NiBound&);
	virtual uint SetupBoneMatrices(NiGeometry*, const NiSkinInstance*,
								   const NiSkinPartition::Partition*,
								   NiGeometryData::RendererData*,
								   const NiPropertyState*,
								   const NiDynamicEffectState*,
								   const NiTransform&, const NiBound&);
	virtual uint SetupShaderPrograms(NiGeometry*, const NiSkinInstance*,
									 const NiSkinPartition::Partition*,
									 NiGeometryData::RendererData*,
									 const NiPropertyState*,
									 const NiDynamicEffectState*,
									 const NiTransform&, const NiBound&);
	virtual NiGeometryData::RendererData*
	PrepareGeometryForRendering(NiGeometry*, const NiSkinPartition::Partition*,
								NiGeometryData::RendererData*,
								const NiPropertyState*);
	virtual uint PostRender(NiGeometry*, const NiSkinInstance*,
							const NiSkinPartition::Partition*,
							NiGeometryData::RendererData*,
							const NiPropertyState*, const NiDynamicEffectState*,
							const NiTransform&, const NiBound&);
	virtual uint PostProcessPipeline(NiGeometry*, const NiSkinInstance*,
									 NiGeometryData::RendererData*,
									 const NiPropertyState*,
									 const NiDynamicEffectState*,
									 const NiTransform&, const NiBound&);
	...
	// virtual bool SetAlphaOverride(uint, bool, bool,
	// NiAlphaProperty::AlphaFunction, bool, NiAlphaProperty::AlphaFunction);
	...
	virtual bool AppendTextureSampler(uint, uint&, const NiFixedString&,
									  const NiFixedString&, uint);
