...
class NiSkinInstance : public NiObject {
  public:
	...
	void Deform(NiGeometryDataIteratorNiPoint3*,
				NiGeometryDataIteratorNiBlendWeights*,
				NiGeometryDataIteratorNiBlendIndices*,
				NiGeometryDataIteratorNiPoint3*, uint, NiPoint3*, NiPoint3*,
				uint) const;
	void Deform(const NiPoint3*, const NiPoint3*, uint, NiPoint3*, NiPoint3*,
				NiPoint3*, NiPoint3*, uint) const;
	void Deform(const NiGeometryData*, NiPoint3*, NiPoint3*, NiPoint3*,
				NiPoint3*, uint) const;
	...
	void ConcatSkinToBoneTransform(uint, const NiTransform&,
								   NiTransform&) const;
	void ConcatBoneWorldTransformAndSkinToBoneTransform(uint,
														NiTransform&) const;
