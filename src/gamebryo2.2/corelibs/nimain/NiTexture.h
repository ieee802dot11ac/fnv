  ...
  public:
	...
	class RendererData : public NiObject {
	  public:
		...
		static void SetTextureFailureCallback(
			NiPixelData* (*)(NiTexture*, CreationFailure));
		static NiPixelData* DefaultTextureFailureCallback(NiTexture*,
														  CreationFailure);
	  ...
	  protected:
		...
		static NiPixelData* (*ms_pfnTextureFailureCallback)(NiTexture*,
															CreationFailure);
		static NiPointer<NiPixelData> ms_aspReplacementData[10];
		static NiPixelFormat ms_kReplacementFormat;
		static NiPixelData*
		GetReplacementData(NiTexture*, NiTexture::RendererData::CreationFailure,
						   bool);
		static NiPixelData* MakeDataFromColors(const NiColorA&, const NiColorA&,
											   const NiPixelFormat&,
											   unsigned int);
		static void
			ReportDataCreationError(NiTexture::RendererData::CreationFailure);
	};
