  ...
  public:
	...
	class Map {
	  public:
		...
		Map(NiTexture*, uint, NiTexturingProperty::ClampMode,
			NiTexturingProperty::FilterMode, NiTextureTransform*);
		Map();
		virtual ~Map();
	...
	class BumpMap : public Map {
	  public:
		...
		BumpMap(NiTexture*, uint, NiTexturingProperty::ClampMode,
				NiTexturingProperty::FilterMode, float, float, float, float,
				float, float);
		BumpMap();
	...
	class ParallaxMap : public Map {
	  public:
		...
		ParallaxMap(NiTexture*, uint, NiTexturingProperty::ClampMode,
					NiTexturingProperty::FilterMode, float);
		ParallaxMap();
	...
	class ShaderMap : public Map {
	  public:
		...
		ShaderMap(NiTexture*, uint, NiTexturingProperty::ClampMode,
				  NiTexturingProperty::FilterMode, uint);
		ShaderMap();
		uint GetID() const;
		void SetID(uint);
		virtual ~ShaderMap();
	...
	NiTexturingProperty(NiPixelData*, const NiFixedString&,
