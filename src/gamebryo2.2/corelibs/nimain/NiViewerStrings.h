...
inline void NiAddViewerString(const NiRTTI* pkRTTI,
							  NiTPrimitiveArray<char*>* pStrings) {
	char* str = NiGetViewerString(pkRTTI->GetName());
	pStrings->Add(str);
}

inline void NiAddViewerString(const char* pcPrefix, const NiFixedString& kValue,
							  NiTPrimitiveArray<char*>* pStrings) {
...
template <typename T>
inline void NiAddViewerString(const char* pcPrefix, T& pValue,
							  NiTPrimitiveArray<char*>* pStrings) {
