...
public:
    ...
    static void SetFileCreateFunc(NiFile *(*)(const char *, OpenMode, unsigned int));
...
protected:
    ...
    static unsigned int
    ReadNoSwap(NiBinaryStream *, void *, unsigned int, unsigned int *, unsigned int);
    static unsigned int WriteNoSwap(
        NiBinaryStream *, const void *, unsigned int, unsigned int *, unsigned int
    );
    static unsigned int
    ReadAndSwap(NiBinaryStream *, void *, unsigned int, unsigned int *, unsigned int);
    static unsigned int WriteAndSwap(
        NiBinaryStream *, const void *, unsigned int, unsigned int *, unsigned int
    );
