...
hkResult hkClass::retrieveMember(int memberIndex, const void*& defaultOut,
...
hkClass::hkClass(const char* className, const hkClass* parentClass,
				 int objectSizeInBytes, const hkClass** implementedInterfaces,
				 int numImplementedInterfaces, const hkClassEnum* declaredEnums,
				 int numDeclaredEnums, const hkClassMember* declaredMembers,
				 int numDeclaredMembers, const void* defaults,
				 const hkCustomAttributes* attributes, uint flags,
	...
	: m_numImplementedInterfaces(numImplementedInterfaces),
	  ...
	  m_numDeclaredMembers(numDeclaredMembers), m_defaults(defaults),
	  m_attributes(attributes), m_flags(flags),
