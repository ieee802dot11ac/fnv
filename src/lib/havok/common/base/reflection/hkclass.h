...
class hkClass { /* Size=0x24 */
  public:
	...
	hkClass(char const*, hkClass const*, int, hkClass const**, int,
			hkClassEnum const*, int, hkClassMember const*, int, void const*,
			hkCustomAttributes const*, unsigned int, unsigned int);
