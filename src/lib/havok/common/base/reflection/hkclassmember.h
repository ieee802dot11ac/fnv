...
class hkClassMember { /* Size=0x18 */
  ...
  public:
	...
	int getTypeName(char*, int) const;
	...
	int getEnumValue(const void*) const;
	void setEnumValue(void*, int) const;
	int getOffset() const;
	void setOffset(int);
	hkFlags<enum hkClassMember::FlagValues, unsigned short>& getFlags();
	const hkFlags<enum hkClassMember::FlagValues, unsigned short>&
	getFlags() const;
