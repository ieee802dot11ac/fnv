...
class CSpeedTreeRT {
  ...
  public:
	...
	void GetGeometry(CSpeedTreeRT::SGeometry&, unsigned long, short, short,
					 short);
	...
	void GetCollisionObject(u32, CSpeedTreeRT::ECollisionObjectType&, float*,
							float*);
  ...
  private:
	...
	static void GetTransitionValues(float, unsigned short, float, float, float,
